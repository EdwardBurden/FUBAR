...
namespace FUBAR
{
    public class ObjectSelectionManager
    {
        ...
        public void ChangeSelection(ClickObject clickObject)
        {
            if (clickObject && !SelectObjects.Contains(clickObject))
                SelectionAdded(clickObject);
            else
                SelectionRemoved(clickObject);
        }
        ...
        private void SelectionRemoved(ClickObject clickObject)
        {
